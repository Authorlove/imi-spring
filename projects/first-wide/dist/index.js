...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/melonzhang/Desktop/project/first-wide/src/index.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-8a593414", Component.options)
	  } else {
	    hotAPI.reload("data-v-8a593414", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(7)("6bc86298", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8a593414!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
	     var newContent = require("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8a593414!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\nhtml {\n\tbackground-color: #fff;\n}\nbody {\n\tposition: relative;\n}\nhtml,\nbody,\n.container,\n.header {\n\tmin-width: 980px;\n\tmax-width: 100%;\n\twidth: 100%;\n}\n\n\n", "", {"version":3,"sources":["/./src/index.vue?0c781b46"],"names":[],"mappings":";AAEA;CACA,uBAAA;CACA;AAEA;CACA,mBAAA;CACA;AAEA;;;;CAIA,iBAAA;CACA,gBAAA;CACA,YAAA;CACA","file":"index.vue","sourcesContent":["<style>\n\t@import \"../common/css/_reset.css\";\n\thtml {\n\t\tbackground-color: #fff;\n\t}\n\t\n\tbody {\n\t\tposition: relative;\n\t}\n\t\n\thtml,\n\tbody,\n\t.container,\n\t.header {\n\t\tmin-width: 980px;\n\t\tmax-width: 100%;\n\t\twidth: 100%;\n\t}\n\t\n\t\n</style>\n<template>\n\t<div class=\"container\" id=\"container\">\n\t\t<t-header></t-header>\n\t\t<t-main></t-main>\n\t\t\n\t</div>\n</template>\n\n<script>\n\timport header from '../components/header.vue'\r\n\timport main from '../components/main.vue'\n\tmodule.exports = {\n\t\tcomponents: {\n\t\t\t't-header': header,\r\n\t\t\t't-main': main\n\t\t},\n\t\tdata: {\n\n\t\t},\n\t\twatch: {\n\n\t\t},\n\t\tcomputed: {\n\n\t\t},\n\t\tmethods: {\n\n\t\t},\n\t\tcreated() {\n\t\t\t\n\t\t},\n\t\tmounted() {\n\t\t\t\n\t\t}\n\n\t}\n</script>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/melonzhang/Desktop/project/first-wide/components/header.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(7)("1e694ee8", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/melonzhang/Desktop/project/first-wide/components/main.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(7)("8f521aba", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _case = __webpack_require__(35);
	
	var _case2 = _interopRequireDefault(_case);
	
	var _clients = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/melonzhang/Desktop/project/first-wide/components/about.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(7)("b6ae67b6", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/melonzhang/Desktop/project/first-wide/components/case.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(7)("8d3e74e6", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/melonzhang/Desktop/project/first-wide/components/clients.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(7)("28fc4002", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/melonzhang/Desktop/project/first-wide/components/contact.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(7)("42a6805c", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.contact_wrap {\n\twidth: 100%;\n\tposition: relative;\n}\n.contact_bg {\n\twidth: 100%;\n}\n.contact_logo {\n\tposition: absolute;\n\twidth: 246px;\n\theight: 70px;\n\tright: 20px;\n\ttop: 150px;\n}\n.contact_logo img {\n\twidth: 100%;\n}\n.contact_text {\n\ttext-align: right;\n\tpadding: 5px;\n\tposition: absolute;\n\twidth: 246px;\n\tright: 20px;\n\ttop: 240px;\n\tborder: 2px solid #fff;\n}\n.contact_text span{\n\tcolor: #D15F96;\n}\n", "", {"version":3,"sources":["/./components/contact.vue?b664f67e"],"names":[],"mappings":";AACA;CACA,YAAA;CACA,mBAAA;CACA;AAEA;CACA,YAAA;CACA;AAEA;CACA,mBAAA;CACA,aAAA;CACA,aAAA;CACA,YAAA;CACA,WAAA;CACA;AAEA;CACA,YAAA;CACA;AAEA;CACA,kBAAA;CACA,aAAA;CACA,mBAAA;CACA,aAAA;CACA,YAAA;CACA,WAAA;CACA,uBAAA;CACA;AACA;CACA,eAAA;CACA","file":"contact.vue","sourcesContent":["<style>\n\t.contact_wrap {\n\t\twidth: 100%;\n\t\tposition: relative;\n\t}\n\t\n\t.contact_bg {\n\t\twidth: 100%;\n\t}\n\t\n\t.contact_logo {\n\t\tposition: absolute;\n\t\twidth: 246px;\n\t\theight: 70px;\n\t\tright: 20px;\n\t\ttop: 150px;\n\t}\n\t\n\t.contact_logo img {\n\t\twidth: 100%;\n\t}\n\t\n\t.contact_text {\n\t\ttext-align: right;\n\t\tpadding: 5px;\n\t\tposition: absolute;\n\t\twidth: 246px;\n\t\tright: 20px;\n\t\ttop: 240px;\n\t\tborder: 2px solid #fff;\n\t}\n\t.contact_text span{\n\t\tcolor: #D15F96;\n\t}\n</style>\n<template>\n\t<div class=\"contact_wrap\">\n\t\t<img class=\"contact_bg\" src=\"../images/contact_bg.jpg\" />\n\n\t\t<div class=\"contact_logo\">\n\t\t\t<img src=\"../images/minilogo2.png\" />\n\t\t</div>\n\n\t\t<div class=\"contact_text\">\n\t\t\t<span>Your Bespoke Program</span><br /><br />\n\t\t\tiMi-Spring Partners<br />\n\t\t\tSuite 202, HuaiZhong Mansion<br />\n\t\t\t1162 Middle Huaihai Road<br />\n\t\t\tShanghai, China<br />\n\t\t\t<span>T</span>. +86 21 6473 0600 ext. 213<br />\n\t\t\t<span>C</span>. + 86 177 2147 0932<br />\n\t\t\t<span>E</span>. inquiry@imi-spring.com\n\n\t\t</div>\n\n\t</div>\n</template>\n\n<script>\n\tmodule.exports = {\n\t\tcomponents: {},\n\t\tdata() {\n\t\t\treturn {\n\n\t\t\t}\n\t\t},\n\t\twatch: {\n\n\t\t},\n\t\tcomputed: {\n\n\t\t},\n\t\tmethods: {\n\n\t\t},\n\t\tcreated() {\n\n\t\t},\n\t\tmounted() {\n\n\t\t}\n\n\t}\n</script>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_c('span', [_vm._v("Your Bespoke Program")]), _c('br'), _c('br'), _vm._v("\n\t\tiMi-Spring Partners"), _c('br'), _vm._v("\n\t\tSuite 202, HuaiZhong Mansion"), _c('br'), _vm._v("\n\t\t1162 Middle Huaihai Road"), _c('br'), _vm._v("\n\t\tShanghai, China"), _c('br'), _vm._v(" "), _c('span', [_vm._v("T")]), _vm._v(". +86 21 6473 0600 ext. 213"), _c('br'), _vm._v(" "), _c('span', [_vm._v("C")]), _vm._v(". + 86 177 2147 0932"), _c('br'), _vm._v(" "), _c('span', [_vm._v("E")]), _vm._v(". inquiry@imi-spring.com\n\n\t")])])
	}]}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-8a593414", module.exports)
	  }
	}
